...
bwr I don't think you need to add examples -->
...
<!-- at all, and imagine some kind of selection effect or xxx must be involved, but if numbers were vanishingly low, it would seem hard to accidentally get them that high through non-obvious selection effects, etc. -->
...
<!-- <p id="gdcalert1" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/image1.png). Store image on your image server and adjust path/filename/extension if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert2">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>xxx
...
<!-- bwr but at least Scott's post originally was based partly on the study that Zvi later objected to; not sure if he then updated it. Perhaps worth mentioning that here.xxx -->
...
<!-- bwr this 'y' link is probably not what you wanted -->
...
<!-- **N. I see mixed evidence about whether covid frequently involves tiny blood clots throughout your body.**

For instance:
* “[In summary](https://ashpublications.org/bloodadvances/article/5/3/756/475081/Sustained-prothrombotic-changes-in-COVID-19), COVID-19 patients have sustained prothrombotic changes as evidenced by enhanced thrombin-generating capacity and decreased plasma fibrinolytic potential at 4 months after hospital discharge.”
* “[In conclusion](https://www.nature.com/articles/s41598-021-81166-y#Fig1), the thrombotic rates were low and did not differ between COVID-19 and non-CoV-2-RV patients.”
* [Meta-analysis](https://www.thelancet.com/journals/eclinm/article/PIIS2589-5370(20)30383-7/fulltext) seems to find very high rates of various bad blood clotting things:
    * Overall venous thromboembolism rate was 21%
    * Overall deep vein thrombosis rate was 20%
    * Overall pulmonary embolism rate was 13%
    * Overall arterial thromboembolism rate was 2%
* “[COVID-19 can infect an asymptomatic person](https://f1000research.com/articles/10-1112) silently without any overt symptoms despite diffuse blood clots throughout the body. Clot formation is induced by COVID-19 associated coagulopathy that can cause a high mortality rate.”

I know I already mentioned death and various bodily systems being messed up, but heuristically, I just really especially don't want tiny blood clots throughout my body. It's one of my personal favorite things to not have, so it's getting a special shout out.  -->

<!-- bwr may want to expand "VT" above; I think "Virginia Tech" or "Vermont" until reading "venous thromboembolism" -->
...
<!-- bwr I think it would be helpful to say "got covid at least twice" rather than "more than once", to help with interpreting the following clauses that refer to "the first", "the second", and "both" -->
...
<!-- bwr I think this is a really good point and I understand more what you were saying before about people seeming fatalistic.

At some point, it would have seemed prohibitively costly to not get other people’s shit on you all the time, so you might have said ‘I guess we’re all going to get <every disease contained in other people’s shit>’. And maybe that would have been the right move then, but avoiding such things has become no biggie at all, because norms have changed to include this kind of hygiene. ] -->


<!-- 4. Whether everyone will get it depends a lot on behavior.  -->
...
<!-- bwr probably finish this sentence? or not; seems like this bullet might be slightly redundant with earlier things -->
...
<!-- But also, it looks to me like long covid is fairly non-fine. -->

<!-- bwr seems awesome overall; maybe you should post it without even taking out any of the xxxs or the formatting issues. -->
